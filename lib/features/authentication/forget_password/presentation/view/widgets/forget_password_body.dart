...
class _ForgetPasswordBodyState extends State<ForgetPasswordBody> {
  ...
  Widget build(BuildContext context) {
    return  BlocConsumer<ForgotPasswordSendCodeCubit, ForgotPasswordSendCodeState>(
             ...
             Center(
               child: CustomButton(
                    onPressed: (){
                      ...
                      {
                        BlocProvider.of<ForgotPasswordSendCodeCubit>(context).forgotPasswordSendCode(email:email!);
