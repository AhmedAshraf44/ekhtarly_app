              ...
              return AnimatedBuilder(
                ...
                child: Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child:  CustomHomeSlider(itemTips:items.itemTipsList[index],number: items.itemTipsList.length,pageNumber: pageNumber,),
                  ),
                ),
              );
            },
      ...
      children: List.generate(
        ...
        (index) => Padding(
          ...
          child: Icon(
            ...
            size: 12,
            color:
                pageNumber == index ?const Color(0xffFFFFFF): const Color(0xff95969D),
...
class CustomHomeSlider extends StatelessWidget {
  const CustomHomeSlider({
    super.key, required this.itemTips, required this.pageNumber, required this.number,
  });
    ...
    return Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(itemTips.image), fit: BoxFit.cover,),
            //color: kPrimaryColor, 
        ...
        child:AspectRatio(
          ...
          children: [
                ...
                child: Center(child: Text(itemTips.textTips,style: Styles.textStyle20.copyWith(color: const Color(0xffFFFFFF),),textAlign: TextAlign.center,maxLines: 4,)),
              ),
                              const SizedBox(
                  height: 5,
                ),
